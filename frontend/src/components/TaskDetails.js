...
const TaskDetails = ({ task }) => {
  ...
  const handleCheck=(t)=>{
     const updateCompletedTask=t.completed==="No" ;
     updateCompletedTask ? t.completed="Yes" : t.completed="No"
     setCompleted({...t,completed:"Yes" ? "No" : "Yes"})
  ...
  return (
    <div className="workout-details">
      ...
      <span className="delete material-symbols-outlined" onClick={handleClick}>delete</span>
       <i className='check-icon' onClick={()=> handleCheck(task)}>
